                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav ms-auto mb-2 mb-lg-0 text-uppercase">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="vmaz.php">вмаз</a>
                            </li>
                            <li class="nav-item">
        ...
        <div class="container mt-3 mb-5">
            <form  action="submit.php" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="name_user_vmaz" class="form-control" placeholder="Прізвище"  required>
                </div>
                <div class="mb-3">
                    <label for="disabledSelect" class="form-label">Вибрати зміну</label>

                    <select id="disabledSelect"  name="zmina_vmaz" class="form-select">
                        <option>Зміна</option>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            ...
                            <div class="mb-3">
                                ...
                                <select id="disabledSelect" name="total_facts_vmaz" class="form-select">
                                    <option>0</option>
                                    <option>1</option>
                                    <option>2</option>
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="name_carrier_vmaz" class="form-control"  placeholder="ТОВ 'Автосвіт ЛТД' м.Коростень">
                            </div>
                            <div class="mb-3">
                                ...
                                <select id="disabledSelect" name="provedeno_perevirok_vmaz" class="form-select">
                                    <option>0</option>
                                    <option>1</option>
                                    <option>2</option>
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <select id="disabledSelect" name="skladeno_protokoliv_vmaz" class="form-select">
                                    <option>0</option>
                                    <option>1</option>
                                    <option>2</option>
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <select id="disabledSelect" name="subyekty_yaki_vidmovylys_vmaz" class="form-select">
                                    <option>0</option>
                                    <option>1</option>
                                    <option>2</option>
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <select id="disabledSelect" name="provedeno_perevirok_zd_vmaz" class="form-select">
                                    <option>0</option>
                                    <option>1</option>
                                    <option>2</option>
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <select id="disabledSelect" name="skladeno_protokoliv_zd_vmaz" class="form-select">
                                    <option>0</option>
                                    <option>1</option>
                                    <option>2</option>
                                </select>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select id="disabledSelect" name="illegal_carriers_checked_vmaz" class="form-select">
                                        <option>0</option>
                                        <option>1</option>
                                        <option>2</option>
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select id="disabledSelect" name="vidsutnist_litsenziyi_vmaz" class="form-select">
                                        <option>0</option>
                                        <option>1</option>
                                        <option>2</option>
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select id="disabledSelect" name="vidsutnist_marshrutu_vmaz" class="form-select">
                                        <option>0</option>
                                        <option>1</option>
                                        <option>2</option>
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select id="disabledSelect" name="vidsutnist_masky_vmaz" class="form-select">
                                        <option>0</option>
                                        <option>1</option>
                                        <option>2</option>
                                    </select>
